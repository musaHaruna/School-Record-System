...
const AddClasss = () => {
  ...
  const [createClass, {isLoading, isSuccess,error}]=useCreateClassMutation()
  ...
  return (
    ...
    <DialogTrigger >
       <span onClick={()=>setOpenDialog(true)} className="h-10 px-4 py-4 rounded-lg bg-[#4a3aff] text-white hover:bg-[#5446f2] flex items-center gap-2 ">
      <Plus />
       Add New Class
       </span>
      ...
      <DialogHeader>
        <DialogTitle className="font-semibold">Add New Class</DialogTitle>
            ...
            <form onSubmit={handleSubmit}  className='flex flex-col gap-4 mt-3'>
                ...
                <Button className="bg-[#4a3aff] text-white hover:bg-[#5446f2]">{isLoading ? <Loader2  className='animate-spin'/> :  "Create Class"}</Button>
