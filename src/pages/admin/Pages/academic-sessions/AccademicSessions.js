        ...
        <div className='max-w-7xl mx-auto p-4 flex flex-col gap-6'>
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
                ...
                <div className="flex flex-col">
                    <h1 className="text-[20px] sm:text-[32px]">All Academic Sessions,</h1>
            ...
            {data.length === 0 ? 
               <div className='flex items-center justify-center w-full flex-col gap-2 mt-12'>
                    ...
                    <p className='text-black text-[18px] font-semibold tracking-wide'>No academic session created!</p>
               </div>
              : 
