...
const SingleSession = ({session}) => {
  ...
  return (
    ...
    <DialogTrigger >
        <span onClick={()=>setOpenDialog(true)} className='p-2 bg-gray-100 rounded-md hover:bg-gray-300 transition duration-300' >View</span>
    </DialogTrigger>
    <DialogContent>
      <DialogHeader>
        <DialogTitle className="font-semibold text-[20px]">{session.name} Session</DialogTitle>
      </DialogHeader>
