       ...
       <div className='bg-white  min-h-screen px-4 sm:px-10 py-6 flex flex-col gap-6'>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-6'>
                    ...
                    alt='img' className='w-[50px] h-[50px] sm:w-[80px] sm:h-[80px] rounded-full' />
            ...
            <form onSubmit={handleSubmit} className='mt-6 flex flex-col gap-4'>
             ...
             <div className='w-full border border-gray-200 p-4 flex flex-col gap-4 '>
                ...
                <Button className="mt-4 bg-[#4a3aff] hover:bg-[#5144e3]">{isLoading ? <Loader className='animate-spin' /> : "Add Student"}</Button>
            </form>
       </div>
    </section>
  )
