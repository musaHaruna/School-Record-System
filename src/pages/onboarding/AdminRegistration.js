        ...
        <div className='flex-1 flex justify-center items-center'>
            <div className='w-full py-10 sm:py-18 px-6 sm:px-12 flex flex-col justify-center items-center gap-6'>
                <div className='flex flex-col gap-2 justify-center items-center'>
                    ...
                    <p className='text-[16px] text-center'>Register as an Admin into Perculiar Treasure School </p>
                </div>

                <form onSubmit={handleSubmit} className='w-full flex flex-col gap-4 mt-4 sm:max-w-[700px] justify-start p-2 sm:p-6  '>
                    ...
                    <Button className="w-full bg-[#4a3aff] hover:bg-[#4e3ffa] "> {isLoading ? <Loader2 className='animate-spin' /> : "Register"}</Button>
